...
**12/12 CRITICAL closed. ~28/39 HIGH closed.**
...
**HIGH remaining** (~11): web 2 (CSRF, locale parity); routes-conversations 1 (LOCKER-04 sweep — multi-commit work); routes-transcriptions 5 (agent-stream AbortSignal forward, etc.); api-core 1 (as-unknown-as cluster); byok-guard 1 (bearer-in-query-value — partially covered by CR-10 fix).
