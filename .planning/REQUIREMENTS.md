...
| LOCKER-05 | 31 / 37 | WARN-only-pending-Phase-37 | `tools/lint-secret-shape-in-error.ts` shipped WARN-only in Plan 31-05; BLOCKING flip lands with Phase 37 (CRIT-FIX-09). |
