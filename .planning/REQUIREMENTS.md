...
| CRIT-FIX-02 | 33 | Pending | Migration pair `0019_envelope_encrypt_secret_columns_add.sql` (additive) + Node backfill (Plan 33-03) + `0020_envelope_encrypt_secret_columns_drop_plaintext.sql` (final) + Drizzle lens + `lint-no-plaintext-secret-columns` (Rule 15) + `docs/security.md` — Source: `data.md` CR-02 |
