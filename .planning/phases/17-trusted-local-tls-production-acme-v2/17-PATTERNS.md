...
Only `.dockerignore` in the repo today is root (23 lines, `/Users/dev/openwhispr-server/.dockerignore`). Phase 17 introduces the SECOND `.dockerignore` at `compose/traefik/.dockerignore`. This is the highest-risk pattern in Phase 17.
