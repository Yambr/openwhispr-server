...
- User provided working Yandex reference: `/Users/nick/Downloads/server.py` (currently macOS-sandboxed).
...
**User's choice (free-text):** "UI будет не пизди тебе надо будет потом для него спеку написать, и делаем все по спеке вот для приложения /Users/nick/openwhispr/"
