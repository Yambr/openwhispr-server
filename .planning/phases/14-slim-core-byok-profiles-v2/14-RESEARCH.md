...
Source: `/Users/dev/openwhispr-server/docker-compose.yml` (871 lines).
...
Source: `/Users/dev/openwhispr-server/tools/bootstrap.sh:39, 191, 199-202`.
...
`/Users/dev/openwhispr-server/apps/worker/src/otel-bootstrap.ts`) — same
...
- Repo: `/Users/dev/openwhispr-server/docker-compose.yml` (871 lines)
- Repo: `/Users/dev/openwhispr-server/apps/worker/src/index.ts`, `queues.ts`, `scheduler.ts`, `jobs/virtual-key-rotation.ts`
- Repo: `/Users/dev/openwhispr-server/apps/api/src/{otel-bootstrap,index,lib/dep-check,lib/redact-url}.ts`
- Repo: `/Users/dev/openwhispr-server/charts/openwhispr/{values.yaml,templates/,tests/}`
- Repo: `/Users/dev/openwhispr-server/tools/bootstrap.sh`
- Repo: `/Users/dev/openwhispr-server/tests/e2e-cjm/{features/,support/compose-harness.ts,support/mailpit-helper.ts}`
- Repo: `/Users/dev/openwhispr-server/.env.example` (88 keys)
- Repo: `/Users/dev/openwhispr-server/.env.embedded.example` (23 keys)
