...
- `/Users/dev/openwhispr/docs/BACKEND_SPEC.md` — relevant for `transcribe.feature` round-trip assertions; do NOT duplicate spec invariants inside `.feature` files (contract-tests remain authoritative).
