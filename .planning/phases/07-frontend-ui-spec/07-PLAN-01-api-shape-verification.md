...
- /Users/dev/openwhispr-server/apps/api/src/routes/stt-config.ts
- /Users/dev/openwhispr-server/apps/api/src/routes/note-recording-config.ts
- /Users/dev/openwhispr-server/apps/api/src/routes/transcriptions/*.ts
- /Users/dev/openwhispr-server/apps/api/src/routes/notes/*.ts
- /Users/dev/openwhispr-server/apps/api/src/routes/conversations/*.ts
- /Users/dev/openwhispr-server/apps/api/src/routes/folders/*.ts
...
- /Users/dev/openwhispr-server/apps/api/src/routes/index.ts
- /Users/dev/openwhispr-server/packages/auth/ (top-level config + session shape)
- /Users/dev/openwhispr-server/packages/wire-schemas/ (if Zod schemas for the above routes exist, prefer them as ground truth)
</files_to_read>

<files_to_modify>
- /Users/dev/openwhispr-server/.planning/phases/07-frontend-ui-spec/UI-SPEC-admin.md (CREATE)
- /Users/dev/openwhispr-server/.planning/phases/07-frontend-ui-spec/UI-SPEC-end-user.md (CREATE)
</files_to_modify>
