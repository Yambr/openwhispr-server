...
@/Users/dev/openwhispr-server/.github/workflows/ci.yml
@/Users/dev/openwhispr-server/lefthook.yml
</context>

<files_to_read>
- /Users/dev/openwhispr-server/.planning/phases/07-frontend-ui-spec/design/ui.jsx (canonical source for color / spacing / typography / motion tokens)
- /Users/dev/openwhispr-server/.planning/phases/07-frontend-ui-spec/UI-SPEC-admin.md (post Plan 04)
- /Users/dev/openwhispr-server/.planning/phases/07-frontend-ui-spec/UI-SPEC-end-user.md (post Plan 05)
- /Users/dev/openwhispr-server/.github/workflows/ci.yml (style + harden-runner pattern)
- /Users/dev/openwhispr-server/lefthook.yml (existing hooks)
- /Users/dev/openwhispr-server/package.json (script confirmation)
</files_to_read>

<files_to_modify>
- /Users/dev/openwhispr-server/.planning/phases/07-frontend-ui-spec/UI-SPEC-admin.md (APPEND appendix block)
- /Users/dev/openwhispr-server/.planning/phases/07-frontend-ui-spec/UI-SPEC-end-user.md (APPEND identical appendix block)
- /Users/dev/openwhispr-server/.github/workflows/ui-spec.yml (CREATE)
- /Users/dev/openwhispr-server/lefthook.yml (MODIFY: add pre-commit ui-spec hook)
- /Users/dev/openwhispr-server/package.json (CONFIRM lint:ui-spec script)
</files_to_modify>
