...
`SERVER-REQUIREMENTS.md` (editable — it lives in `/Users/nick/openwhispr/`, a
different repo, NOT part of this repo's git):

- File: `/Users/nick/openwhispr/.planning/phases/08-client-server-audit/SERVER-REQUIREMENTS.md`
...
- Do NOT commit this file in the openwhispr-server repo (it is not tracked
  here). Commit it in the `/Users/nick/openwhispr/` repo if that repo's
