...
- `/Users/dev/openwhispr/docs/SELF_HOSTING.md` — wire walkthrough
- `/Users/dev/openwhispr/docs/BACKEND_SPEC.md` — per-endpoint contract
- `/Users/dev/openwhispr/docs/OAUTH_SPEC.md` — auth flows
