...
- `/Users/nick/openwhispr/docs/BACKEND_SPEC.md` §`/api/agent/stream` (lines ~300-348) — NDJSON chunk vocabulary, request body, error deviations
- `/Users/nick/openwhispr/docs/BACKEND_SPEC.md` §`/api/streaming-token` (lines ~482-508) — AssemblyAI mint shape
- `/Users/nick/openwhispr/docs/BACKEND_SPEC.md` §`/api/deepgram-streaming-token` (lines ~510-532) — Deepgram mint shape
- `/Users/nick/openwhispr/docs/BACKEND_SPEC.md` §`/api/openai-realtime-token` (lines ~534-572) — OpenAI Realtime mint, streams=1|2 semantics
- `/Users/nick/openwhispr/docs/BACKEND_SPEC.md` §header conventions — `Content-Type`, global error envelope, dual-auth
