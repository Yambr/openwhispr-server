...
E2E tests live in `/Users/dev/openwhispr-server/tests/e2e/`. Spec files follow `phase-NN-<name>.spec.ts` (e.g., `phase-05-conversations.spec.ts`) or `<feature>.e2e.test.ts` patterns.
