...
3. **A5/A6 — `wordsUsed` semantics in WIRE-05.**
   ...
   - Recommendation: Spike — read `/Users/dev/openwhispr/docs/BACKEND_SPEC.md` (1556 lines, mentioned in CLAUDE.md as authoritative) to confirm; planner extracts the canonical schema. If unable, default to minutes (matches ledger kind) and document.
