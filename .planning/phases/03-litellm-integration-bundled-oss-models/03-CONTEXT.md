...
User направление: "идём строго по схеме клиента, минимальные правки в клиенте". Wave 0 task: read upstream `/Users/dev/openwhispr/docs/BACKEND_SPEC.md` (1556 lines, mentioned в CLAUDE.md как authoritative spec), extract:
