...
- **Chosen: option-a** (drop `"tool"` server-side, align DOWN to the canonical contract). Single server-only edit; `/Users/dev/openwhispr` untouched; **no upstream client follow-up required.**
