...
- **Found during:** Task 1 — early test runs reported "No test files found" because a `cd /Users/nick/openwhispr-server` Bash call resolved to the MAIN repo, not the worktree; the Written test file lived in the worktree.
