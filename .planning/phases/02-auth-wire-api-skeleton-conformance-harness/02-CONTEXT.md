...
- `/Users/nick/openwhispr/docs/SELF_HOSTING.md` — wire walkthrough; § Authentication Contract; § OAuth Flow Walkthrough; § Custom Protocol Channel Variants; § Edge Cases
- `/Users/nick/openwhispr/docs/BACKEND_SPEC.md` — per-endpoint contract; § Conventions; § Global Error Envelope; cards for the 4 endpoints in scope
