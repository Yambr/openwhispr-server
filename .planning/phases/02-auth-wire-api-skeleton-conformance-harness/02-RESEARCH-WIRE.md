...
- `/Users/nick/openwhispr/docs/BACKEND_SPEC.md` — § Conventions, § Global Error Envelope, cards for 4 endpoints (read 2026-05-09)
- `/Users/nick/openwhispr/docs/SELF_HOSTING.md` — § Authentication Contract, § Edge Cases (read 2026-05-09)
- `/Users/nick/openwhispr-server/.planning/phases/02-auth-wire-api-skeleton-conformance-harness/02-CONTEXT.md` — D-09..D-21, D-28
- `/Users/nick/openwhispr-server/.planning/research/PITFALLS.md` — pitfalls #1, #4, #5, #8 (read 2026-05-09)
- `/Users/nick/openwhispr-server/CLAUDE.md` — Project + Stack constitutional docs
- `/Users/nick/openwhispr-server/packages/data/src/schema/users.ts` — schema verified
- `/Users/nick/openwhispr-server/packages/contract-tests/` — Phase 0 shell
