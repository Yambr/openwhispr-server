...
| 2-02-1 | 02 | 1 | PROVIDER-04 (foundation) | build | `pnpm -F @openwhispr/api build && pnpm -F @openwhispr/data build && grep -q 'exec "$@"' apps/api/entrypoint.sh && pnpm -F @openwhispr/data test --run src/__tests__/migrate.test.ts` | pending |
