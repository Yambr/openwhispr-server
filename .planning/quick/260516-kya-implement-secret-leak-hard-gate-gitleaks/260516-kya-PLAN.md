...
Purpose: Eliminate the gap where `git add .env` or `git commit --no-verify` can push a secret to GitHub before CI fires. Approved plan: `/Users/dev/.claude/plans/jolly-questing-narwhal.md`.
...
<context>
@/Users/dev/.claude/plans/jolly-questing-narwhal.md
@CLAUDE.md
@lefthook.yml
@.github/workflows/security.yml
@tools/install-hooks.cjs
