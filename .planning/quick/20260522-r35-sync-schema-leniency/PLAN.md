...
<task type="auto" tdd="true">
  ...
  <verify>
    <automated>cd /Users/dev/openwhispr-server && pnpm --filter @openwhispr/wire-schemas test r35-sync-schema-leniency 2>&1 | tail -20</automated>
  </verify>
...
<task type="auto" tdd="true">
  ...
  <verify>
    <automated>cd /Users/dev/openwhispr-server && pnpm --filter @openwhispr/wire-schemas test r35-sync-schema-leniency 2>&1 | tail -15 && pnpm --filter @openwhispr/wire-schemas exec tsc --noEmit 2>&1 | tail -5</automated>
  </verify>
...
<task type="auto" tdd="true">
  ...
  <verify>
    <automated>cd /Users/dev/openwhispr-server && pnpm --filter @openwhispr/api test r35-sync-leniency 2>&1 | tail -25</automated>
  </verify>
...
<task type="auto">
  ...
  <verify>
    <automated>cd /Users/dev/openwhispr-server && pnpm --filter @openwhispr/wire-schemas test 2>&1 | tail -8 && pnpm lint:lockers 2>&1 | tail -15</automated>
  </verify>
