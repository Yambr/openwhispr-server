...
Source: `/Users/dev/openwhispr/.planning/phases/08-client-server-audit/SERVER-REQUIREMENTS.md` (12 requirements R1..R12) produced by upstream Electron client's Phase 8 + Phase 9 closures. One-directional rule: server adapts, client doesn't migrate (client repo is upstream-parity and refuses bridging patches). Pre-OSS, zero deprecation cost.
