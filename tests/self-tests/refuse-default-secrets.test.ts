...
const PLACEHOLDER_ENV_EXAMPLE = [
  "POSTGRES_OWNER_PASSWORD=PLACEHOLDER_OWNER",
  "POSTGRES_APP_PASSWORD=PLACEHOLDER_APP",
  "PGBOUNCER_ADMIN_PASSWORD=PLACEHOLDER_PGB",
  "VALKEY_PASSWORD=PLACEHOLDER_VALKEY",
  "MINIO_ROOT_PASSWORD=PLACEHOLDER_MINIO",
  "TRAEFIK_ADMIN_PASSWORD=PLACEHOLDER_TRAEFIK",
  "GRAFANA_ADMIN_PASSWORD=PLACEHOLDER_GRAFANA",
  "MASTER_KEK=PLACEHOLDER_KEK",
  "BACKUP_AGE_IDENTITY=PLACEHOLDER_AGE",
  "BETTER_AUTH_SECRET=PLACEHOLDER_AUTH",
  "",
].join("\n");
