...
} from "../../../src/db/app-pool.js";
import { canRunDocker } from "../../../src/lib/can-run-docker.js";
import { withSystemContext } from "../../../src/lib/with-system-context.js";
import { withTenantContext } from "../../../src/lib/with-tenant-context.js";
...
GUARD_SUITE("app-pool runtime tenant-context guard (D-W4 layer 2)", () => {
  ...
  it("throws when ALS context is tenant-mode but GUC was never bound (defensive)", async () => {
    ...
    const { tenantAls } = await import("../../../src/lib/with-tenant-context");
    await expect(
