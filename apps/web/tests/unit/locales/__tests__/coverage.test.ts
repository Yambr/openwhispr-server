...
import adminBundle from "../../../../src/locales/en/admin.json";
import commonBundle from "../../../../src/locales/en/common.json";
import endUserBundle from "../../../../src/locales/en/end-user.json";
import adminBundleRu from "../../../../src/locales/ru/admin.json";
import commonBundleRu from "../../../../src/locales/ru/common.json";
import endUserBundleRu from "../../../../src/locales/ru/end-user.json";
