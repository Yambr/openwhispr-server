...
import { buildDeepgramTokenRoutes } from "../deepgram.js";
...
describe("rate-limit-isolation — real Valkey 8 testcontainer + real plugin (T-04-04)", () => {
  ...
  it(
    "T6: bucket TTL — register a 2s-timeWindow route, exhaust it, wait 2.5s real wall-clock, fresh 30 succeed (no fake timers)",
    async () => {
