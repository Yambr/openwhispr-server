...
import { TranscribeResponse, ErrorEnvelope } from "@openwhispr/contract-tests/schemas";
import { registerErrorHandler } from "../error-handler.js";
import { zodTypeProvider } from "../plugins/zod-type-provider.js";
import { buildTranscribeRoutes } from "./transcribe.js";
...
function makeFakeLitellm(opts: FakeLitellmOpts): LitellmClient {
  return {
    ...
    async audioTranscriptions(args) {
      ...
      return {
        statusCode: 200,
        body: { async json() { return json; } },
      } as unknown as Awaited<ReturnType<LitellmClient["audioTranscriptions"]>>;
    },
  };
}

function buildApp(deps: Parameters<typeof buildTranscribeRoutes>[0], opts?: { authed?: boolean }): FastifyInstance {
...
function multipartBody(payload: Buffer | string, boundary = "----test-boundary"): { body: Buffer; contentType: string } {
