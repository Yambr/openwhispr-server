...
import {
  ...
  buildTestApp,
  seedUser,
} from "../../../../../../src/routes/v1/keys/__tests__/setup.js";
...
describe("integration — /api/v1/keys CRUD (real Postgres + RLS)", () => {
  ...
  it("401 — missing req.user defensive guard on /list and /create", async () => {
    ...
    const { buildKeysCreateRoutes } = await import("../../../../../../src/routes/v1/keys/create");
    const { buildKeysListRoutes } = await import("../../../../../../src/routes/v1/keys/list");
