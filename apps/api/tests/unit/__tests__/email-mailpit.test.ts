...
const HTTP_BASE = process.env.MAILPIT_HTTP_URL ?? `http://${SMTP_HOST}:8025`;
...
async function pollForSubject(subject: string, budgetMs = 10_000): Promise<MailpitMessage | null> {
